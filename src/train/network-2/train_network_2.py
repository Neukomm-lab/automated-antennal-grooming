...
################################################################################################################################
# checkpoint_name = '2020-12-10_CNN_fly_grooming'
# ROOT_DIR = 'D:\\data-sets\\neukomm\\2020-11-10\\train-val-test\\'
# checkpoint_name = '2022-08-10_network2' 
# ROOT_DIR = r'D:/data-sets/neukomm/2022-08-09/train-validation-set' # used by latest inference (November 2022)
# checkpoint_name = '2022-08-26_network2'
# ROOT_DIR = r'D:\data-sets\neukomm\train-val-test-sets\2022-08-26' # Not very accurate -> better using the 2022-08-09 training set

# >>> Name of the checkpoint to be saved
# checkpoint_name = '2023-01-17_AFTER_injury'
checkpoint_name = '2023-05-17_BEFORE_injury'

################################################################################################################################
# Where to find the training dataset
# ROOT_DIR = r'D:\data-sets\neukomm\train-val-test-sets\2023-01-17_AFTER_injury'
# ROOT_DIR = 'D:/switchdrive/Neuro-BAU/code/GIT/deep_behavior/CNN/fly-grooming-data-set-SUM-10/'
# ROOT_DIR = 'D:/fly-grooming-data-set-SUM-10/'
# ROOT_DIR = 'D://fly_grooming_dataset//network_two//dataset//'
# ROOT_DIR = 'D:\\data-sets\\neukomm\\2020-11-10\\train-val-test\\'
ROOT_DIR = r'D:\data-sets\neukomm\train-val-test-sets\2022-11-18_merge_naive_injury' # used by latest inference (November 2022)
################################################################################################################################
...
image_datasets = {x: datasets.ImageFolder(os.path.join(ROOT_DIR, x), data_transforms[x]) for x in ['train', 'validation']}
...
model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler, num_epochs= 41) #25

torch.save({'model_state_dict': model_ft.state_dict()}, '../../../lib/checkpoints/' + checkpoint_name + '.pt')
...
############ 
'''
The following lines can be used interactively to probe the model 
against some samples that were used during train/validation
'''
